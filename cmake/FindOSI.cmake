...
find_path(OSI_INCLUDE_DIR
          ...
          PATHS "$ENV{OSI_DIR}/include/coin"
                ...
                "/usr/local/opt/osi/include/osi/coin/" # homebrew default path
                "/usr/include/coin"
...
find_library( OSI_LIBRARY_DEBUG
              ...
              PATHS "$ENV{OSI_DIR}/lib"
                    ...
                    "/usr/lib"
                    "/usr/lib/coin"
                    "/usr/local/opt/osi/lib" # homebrew default path
                    "C:\\libs\\OSI\\lib"
                    "C:\\libs\\cbc\\lib"
...
find_library( OSI_CBC_LIBRARY_DEBUG
              ...
              PATHS "$ENV{OSI_DIR}/lib"
                    ...
                    "/usr/lib"
                    "/usr/lib/coin"
                    "/usr/local/opt/cbc/lib" # homebrew default path
                    "C:\\libs\\OSI\\lib"
                    "C:\\libs\\cbc\\lib"
                    "${VS_SEARCH_PATH}CBC-2.9.7/lib/${VS_SUBDIR}Debug"
                    "${VS_SEARCH_PATH}CBC-2.9.4/Osi/lib"
...
find_library( OSI_CLP_LIBRARY_DEBUG
              ...
              PATHS "$ENV{OSI_DIR}/lib"
                    ...
                    "/usr/lib"
                    "/usr/lib/coin"
                    "/usr/local/opt/clp/lib" # homebrew default path
                    "C:\\libs\\OSI\\lib"
                    "C:\\libs\\cbc\\lib"
                    "${VS_SEARCH_PATH}CBC-2.9.7/lib/${VS_SUBDIR}Debug"
                    "${VS_SEARCH_PATH}CBC-2.9.4/Osi/lib"
